...
import com.notify.notificationgatway.model.NotificationGatewayResponse;
...
public class NotificationGatewayController {
    ...
    public ResponseEntity<NotificationGatewayResponse> sendGroupNotification(@RequestBody Notification notification) {
    ...
    @PostMapping(value = "/single",  consumes =MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<NotificationGatewayResponse> sendSingleNotification(@RequestBody Notification notification) {
